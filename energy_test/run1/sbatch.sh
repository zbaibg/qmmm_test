...
sed "s/NUMBEROFCORE/$SLURM_NTASKS/g" orc_job.tpl > orc_job.tpl.new && mv orc_job.tpl.new orc_job.tpl
sander -O -i qmmm.in -o qmmm.out -p input.prmtop -y traj.nc -c input.rst -r qmmm.rst -x qmmm.nc
